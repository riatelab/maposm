kv_green = list("landuse" = c("allotments", "farmland", "cemetery", "forest",
                              "grass", "meadow", "orchard", "recreation_ground",
                              "greenfield", "village_green","vineyard"),
                "amenity" = "grave_yard",
...
kv_urban = list("landuse" = c("commercial", "residential", "industrial",
                              "retail", "institutional", "civic_admin",
                              "railway", "garage"),
                "man_made" = "pier")
